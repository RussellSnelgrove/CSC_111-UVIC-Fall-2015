/*
 ...
 Description : This program creates a tea pot that is shifted by a bit.
 ============================================================================
*/
...
#define HTML5_SVG_OUTPUT_FILENAME ("A7P1_2015_teapot.html")
...
void writePrologue(FILE *f){
	...
	fputs("<html>\n",f);
	fputs("<head>\n",f);
	fputs("<title>CSC 111 Fall 2015 -  Assignment 7 Part 1</title>\n",f);
	fputs("</head>\n",f);
	fputs("<body>\n",f);
